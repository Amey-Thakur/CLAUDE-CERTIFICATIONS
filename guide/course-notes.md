...
Facts last verified against the official sources on 2026-08-31. These notes are the maintainer's own. Course facts come from the [official catalog](courses.md). [Repository index](../README.md)
