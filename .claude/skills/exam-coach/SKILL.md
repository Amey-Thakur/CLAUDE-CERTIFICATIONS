...
2. Read that certification's `README.md` (the blueprint: domains, weights, objectives) and `notes.md`. For deep detail, the official `exam-guide.pdf` in the same folder is the authoritative source.
