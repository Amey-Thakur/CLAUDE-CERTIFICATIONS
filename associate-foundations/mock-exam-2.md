...
| 13 | A | Configuration and Knowledge Management | A deliberate, minimal base keeps retrieval sharp and is maintainable. Uploading everything (B) and accreting without review (D) both dilute, and instruction length (C) is not the question |
