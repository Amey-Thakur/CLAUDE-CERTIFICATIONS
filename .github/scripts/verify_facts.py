...
# certification policy and FAQ pages on 24 September 2026, and the sentence that carries
...
def main():
    ...
    print("\n  Not in the mirrored PDFs. Read off Anthropic's certification "
          "policy and FAQ pages on 24 September 2026, and quoted in this file:")
